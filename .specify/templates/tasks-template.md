...
**Tests / Eval**: The examples below include test tasks. For TraceResearch behavior
changes, tests or eval cases are REQUIRED by the constitution. For unrelated
utility work, include tests only when requested by the feature specification.
...
- [ ] T008 Configure error handling, trace logging, and artifact storage
- [ ] T009 Setup environment configuration management
- [ ] T010 Define Evidence Store schema and evidence ID conventions
- [ ] T011 Define eval seed cases, metrics, thresholds, and result paths
...
- [ ] T019 [US1] Add trace events for agent/tool operations
- [ ] T020 [US1] Add evidence-grounding checks for generated claims
...
- [ ] TXXX Run eval cases and save metrics/bad-case analysis under eval/results/
- [ ] TXXX Verify final reports contain evidence IDs for key claims
...
- Evidence schemas before Writer behavior that depends on grounded claims
- Trace events before eval/review steps that diagnose agent behavior
...
- For Deep Research behavior changes, run eval cases before review
- Any key claim in generated reports must trace to Evidence Store entries
